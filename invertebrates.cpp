...
void Invertebrates::displayAnimal()
{
    Animal::displayAnimal();
}

void Invertebrates::addAnimal()
{
    string animalID;
    string Name;
    string Offsprings;
